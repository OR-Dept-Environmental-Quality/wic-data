...
#'
#' For documentation on WIC, see the items listed under SOURCE below
#'
...
#' @source \url{https://github.com/OR-Dept-Environmental-Quality/wic-base/blob/main/documentation/example-applications-of-the-wic.pdf}
